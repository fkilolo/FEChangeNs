...
// export Interface cho Properties trong BunnyAiImageBlueprint
export interface BunnyAiImageBlueprintProperties {
  PrePrompt: string;
  PostPrompt: string;
}

// export Interface cho BunnyAiImageBlueprint
export interface BunnyAiImageBlueprint {
  Name: string;
  Properties: BunnyAiImageBlueprintProperties;
}
